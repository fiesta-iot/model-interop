...
/**
 * Representations metadata for content negotiation. "AbstractMetadata is in the form of
...
public abstract class AbstractMetadata implements Serializable {
     ...
     * Constructor.
     *
     * @param newName The unique name.
     */
    public AbstractMetadata(final String newName) {
        this(newName, null);
    }
     ...
     *            The description.
     */
    public AbstractMetadata(final String newName, final String descr) {
        this.name = newName;
    ...
    public boolean equals(final Object object) {
        return (object instanceof AbstractMetadata)
                && ((AbstractMetadata) object).getName().equals(getName());
    }
     ...
     */
    public abstract AbstractMetadata getParent();
     ...
     */
    public abstract boolean includes(AbstractMetadata included);
     ...
     */
    public final boolean isCompatible(final AbstractMetadata otherMetadata) {
        final boolean result = (otherMetadata != null)
