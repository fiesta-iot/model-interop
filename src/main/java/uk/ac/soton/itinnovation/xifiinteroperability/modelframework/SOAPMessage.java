...
//import static uk.ac.soton.itinnovation.xifiinteroperability.modelframework.ProtocolMessage.JSON_LABEL;
//import static uk.ac.soton.itinnovation.xifiinteroperability.modelframework.ProtocolMessage.OTHER_LABEL;
//import static uk.ac.soton.itinnovation.xifiinteroperability.modelframework.ProtocolMessage.XML_LABEL;
//
///**
// * SOAP is an example of a message that is encapsulated in a lower level
// * message. For example, it can be a HTTP POST operation. Therefore, there
// * are multiple cross protocol tests that can be made.
// *
// * Tests on the binding operations and tests on the SOAP envelope
// *
// * @author Paul Grace
// */
