 ...
 * @author Paul Grace
 */
public class MQTTEvent extends MsgEvent implements Serializable {
    ...
    public static final String MQTT_FROM = "mqtt.from";

     /**  Where is the message to = IP address of the location sent to. */
    public static final String MQTT_TO = "mqtt.to";

    /** What is the URL path i.e. the HTTP interface of the request. */
    public static final String MQTT_TOINTERFACE = "mqtt.tointerface";

     /**  What is the message type - get, put, delete, post ...*/
    public static final String MQTT_MSG = "mqtt.msg";

    /** A creatable header field. */
    public static final String MQTT_CONFIG_HEAD = "coap.";
    ...
    public final boolean addParameter(final Parameter pNew) {
        return this.inputParams.put(pNew.getName(), pNew) != null;
    }
