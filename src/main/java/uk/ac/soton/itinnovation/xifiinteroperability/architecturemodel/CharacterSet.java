...
/**
 * AbstractMetadata used to specify the character set of textual representations.
 *
 * @author Jerome Louvel
 */
public final class CharacterSet extends AbstractMetadata implements Serializable {

    /**
     * Ensure portably serializable.
     */
     ...
     */
    private static String getIanaName(final String name) {
        if (name != null) {
            String upperName = name.toUpperCase(Locale.ENGLISH);

            if (upperName.equalsIgnoreCase("MACROMAN")) {
                upperName = MACINTOSH.getName();
            } else if (upperName.equalsIgnoreCase("ASCII")) {
                upperName = US_ASCII.getName();
            } else if (upperName.equalsIgnoreCase("latin1")) {
                upperName = ISO_8859_1.getName();
            } else if (upperName.equalsIgnoreCase("latin2")) {
                upperName = ISO_8859_2.getName();
            } else if (upperName.equalsIgnoreCase("latin3")) {
                upperName = ISO_8859_3.getName();
            } else if (upperName.equalsIgnoreCase("latin4")) {
                upperName = ISO_8859_4.getName();
            } else if (upperName.equalsIgnoreCase("cyrillic")) {
                upperName = ISO_8859_5.getName();
            } else if (upperName.equalsIgnoreCase("arabic")) {
                upperName = ISO_8859_6.getName();
            } else if (upperName.equalsIgnoreCase("greek")) {
                upperName = ISO_8859_7.getName();
            } else if (upperName.equalsIgnoreCase("hebrew")) {
                upperName = ISO_8859_8.getName();
            } else if (name.equalsIgnoreCase("latin5")) {
                upperName = ISO_8859_9.getName();
            } else if (name.equalsIgnoreCase("latin6")) {
                upperName = ISO_8859_10.getName();
            }
            return upperName;
        }
        return null;
     ...
     */
    public static CharacterSet valueOf(final String newName) {
        CharacterSet result = null;
        final String name = getIanaName(newName);
    ...
    public CharacterSet(final String name) {
        this(name == null ? null : name.toUpperCase(Locale.ENGLISH),
    ...
    @Override
    public AbstractMetadata getParent() {
     ...
     */
    public boolean includes(final AbstractMetadata included) {
